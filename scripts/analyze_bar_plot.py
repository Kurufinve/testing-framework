...
for model in models:
    ...
    all_data[model]["point_defect_Si_diamond_interstitial_tetr"] = \
    point_defect_data[model]["point_defect_Si_diamond_interstitial_tetr"]["defects"]["Z_14"]["Ef"]
    all_data[model]["point_defect_Si_diamond_vacancy"] = \
    point_defect_data[model]["point_defect_Si_diamond_vacancy"]["defects"]["ind_0_Z_14"]["Ef"]
    all_data[model]["point_defect_Si_diamond_interstitial_hex"] = \
    point_defect_data[model]["point_defect_Si_diamond_interstitial_hex"]["defects"]["Z_14"]["Ef"]
    # print()
    all_data[model]["point_defect_Si_diamond_interstitial_dumb"] = \
    point_defect_data[model]["point_defect_Si_diamond_interstitial_dumb"]["dumbbell_interstitial_energy"]
...
for model in models:
    if model != ref_model_name:
        for obs in all_data[model].keys():
            ...
            all_data[model][obs] = ((all_data[model][obs] - all_data[ref_model_name][obs]) / all_data[ref_model_name][
                obs]) * 100
