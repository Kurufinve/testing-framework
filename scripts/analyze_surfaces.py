...
for model_name in models:
    ...
    for test_name in tests:
        ...
        if data[model_name][test_name]["dmu"] is None:  # single component
            ...
            print(" = [", data[model_name][test_name]["Ef"] + mu_contrib_min_total, "--",
                  data[model_name][test_name]["Ef"] + mu_contrib_max_total, "]")
            l += " = [ {} -- {} ]".format(data[model_name][test_name]["Ef"] + mu_contrib_min_total,
                                          data[model_name][test_name]["Ef"] + mu_contrib_max_total)
